...
# Frame de bienvenida
frame_bienvenida = Frame(ventana_inicio, width=100, height=100,bg="green")
...
boton_inicio=Button(frame_inicio, text="INGRESAR",bg="AntiqueWhite2",width=30,height=5,font=("Arial",10,"bold"),bd=5,relief="raised")
